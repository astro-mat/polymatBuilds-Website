...
I have been putting off getting a new studio PC for ages to replace my aging HPZ 420. I had started to collect the components in order to build one. I had speced out the components in the summer and returned to it in the winter to see that the RAM I had seen for a reasonable €150 was now listed at €700! (Thanks Data-Centres!)
...
![Mat-Top Base PC Unit]({{ "assets/images/MatTop/MatTop_1.jpg" | relative_url }})

I was very impressed with the small size and performance of it after it arrived. I immediatly thought I could make use of this and make the whole setup more portable. This would enable me to move my main PC around where-ever it is needed. 

I really liked the way the Octatrack Travel Case worked [Octatrack Travel Case](https://builds.polymat.ie/builds/OctatrackTravelCase/) and decided to use the same concept for the case. I thopught it would be great to use a touchscreen in the unit and make use of the PC's USB-C display output. I had also seen James Holden's recent build of a live performance PC in which he 3D printed a case to contain PC components [James Holden portable PC](https://codeberg.org/james_holden/prints/src/branch/main/tablet%20pc) 

![Mat-Top Design]({{ "assets/images/MatTop/MatTop_2.jpg" | relative_url }})

The resulting case works quite well. It packs up in a secure, portable format. 

![Mat-Top Closed configuration 1]({{ "assets/images/MatTop/MatTop_3.jpg" | relative_url }})

![Mat-Top Closed configuration 2]({{ "assets/images/MatTop/MatTop_4.jpg" | relative_url }})
